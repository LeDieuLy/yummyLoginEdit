...
<div id="content" class="clearfix " style="width: 100%;">
	<div id="left-area" class="clearfix" style="width: 91%;">
		...
		<div class="post-53 post category-barbeque" id="post-53">
			...
			<a>
			<img 
				src="${pageContext.request.contextPath }/resources/${post.getImage()}" />
			</a>
			</div>
		...
		<div class="comments">
			<div id="whats-hot">
				...
				<a style="float: right; left: 1169px;; top: 203px; line-height: 16px; font-size: 12px; height: 29px; position: absolute;"
					...
					href="${pageContext.request.contextPath}/admin/post-edit${post.id}"><i class="fa fa-edit"
					...
					<ul class="cat-list">
						<c:forEach items="${ refer }" var="item">
							<li class="img-box-2">
								...
								</h3> <a href="recipe-single-1.html" class="img-box img-box-2"> 
								<img 
									src="${pageContext.request.contextPath }/resources/${item.getImage()}" />
