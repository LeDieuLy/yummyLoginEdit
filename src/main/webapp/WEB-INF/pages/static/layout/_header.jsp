						...
						<c:otherwise>
							<c:choose>
								...
								<c:otherwise>
									<li style="margin-left: 250px;"><img class="image_profile"
										style="margin-top: 3px; width: 35px; height: 35px;"
										src="${pageContext.request.contextPath }/resources/${user.getImage()}" /></li>
								</c:otherwise>
							</c:choose>
			...
			<div class="top-search  clearfix">
				...
				<p class="statement">
					...
					<a href="#">Phở</a>
						...
						class="readmore"
						style="background-color: forestgreen; right: 0px; margin-left: 84px; color: white;"> <i class="fa fa-plus" aria-hidden="true"></i>
						  Viết
						bài </a>
