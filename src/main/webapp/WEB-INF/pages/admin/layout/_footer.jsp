				...
				<div class="sidebar sidebar-dark sidebar-left bg-dark-gray ps"
					...
					<div
						...
						<a 
							...
							class="mr-3"> <img src="${pageContext.request.contextPath }/resources/${user.getImage()}" style="width: 46px; height: 46px;" /> 
						</span> <span class="flex d-flex flex-column"> <span
								class="sidebar-brand">${user.getFullname() }</span> <small>${user.getEmail() }</small>
						</span>
						</a>
					</div>
					...
					<div class="sidebar-block p-0">
						<ul class="sidebar-menu mt-0">
							<li class="sidebar-menu-item active"><a
								class="sidebar-menu-button" href="${pageContext.request.contextPath}/admin/list-post"> <i
