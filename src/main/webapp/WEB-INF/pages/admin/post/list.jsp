					...
					<c:forEach items="${ posts }" var="post_detail">
						<tr>
							...
							<td>
								...
								<a class="btn btn-primary" href="${pageContext.request.contextPath}/admin/post-edit${post_detail.id}">
									<span class="menu-icon"><i class="fa fa-edit"></i></span>
								</a>
								
								<button class="btn btn-danger use-block" id="test"
									data-href="${pageContext.request.contextPath}/admin/list-post/${post_detail.id}"
