	...
	<div class="page__heading border-bottom">
		...
		<div class="container-fluid page__container d-flex align-items-center" style="padding-left: 15px;">
			...
			<span id="hideMe" class="${class_name}"
				style="font-size: larger; margin-left: 440px; font-weight: normal; margin-bottom: -18px;">${msg}</span>
				...
				<tbody>
					...
					<c:forEach items="${users}" var="user_detail">
						<tr>
							...
							<td><a id="confirm-block" data-target="#confirm-delete"
								href="" class="btn btn-danger"> <span class="menu-icon"><i
										class="fa fa-trash"></i></span>
							</a>
								<button class="btn btn-warning user-unlock" id="test"
									data-href="${pageContext.request.contextPath}/admin/list-user/${user_detail.id }"
